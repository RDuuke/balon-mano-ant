...
<!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"amarillo-labm"} --><div class="wp-block-button"><a class="wp-block-button__link has-amarillo-labm-background-color has-background wp-element-button" href="/actualidad/"><?php esc_html_e( 'Ver actualidad', 'labm' ); ?></a></div><!-- /wp:button --></div><!-- /wp:buttons --></div>
<!-- /wp:group -->
